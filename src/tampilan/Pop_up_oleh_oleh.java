 ...
 * @author ASUS
 */
public class Pop_up_oleh_oleh extends javax.swing.JFrame {
    private final Connection conn = new koneksi().connect();
    private DefaultTableModel tabmode;
    public form_transaksi_oleh_oleh brg = null;

    public Pop_up_oleh_oleh() {
        initComponents();
        datatable();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Pop Up Oleh-oleh");
    ...
    private void tableoleholehMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableoleholehMouseClicked
        int tabelpelanggan = tableoleholeh.getSelectedRow();
        brg.idbrng  = tableoleholeh.getValueAt(tabelpelanggan, 0).toString();
        brg.nmbrg = tableoleholeh.getValueAt(tabelpelanggan, 1).toString();
        brg.hj = tableoleholeh.getValueAt(tabelpelanggan, 2).toString();
        brg.qty = tabmode.getValueAt(tabelpelanggan, 3).toString();
        brg.total = tabmode.getValueAt(tabelpelanggan, 4).toString();
        brg.itemTerpilihBrg();
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Pop_up_oleh_oleh.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Pop_up_oleh_oleh().setVisible(true);
            }
        });
    }
