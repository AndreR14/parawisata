 ...
 * @author ASUS
 */
public class Pop_up_pengunjung extends javax.swing.JFrame {
    private final Connection conn = new koneksi().connect();
    private DefaultTableModel tabmode;
    public form_transaksi_oleh_oleh pengunjung = null;

    /**
     * Creates new form Pop_up_pengunjung
     */
    public Pop_up_pengunjung() {
        initComponents();
        datatable();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Pop_up_pengunjung.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Pop_up_pengunjung().setVisible(true);
            }
        });
    }
